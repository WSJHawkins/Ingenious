...
for z in range(0, 1):
    ...
    for n in range(numOfGames):
        ...
        for i in range(0, 1000):
            ...
            anotherGo = 1
            while anotherGo == 1:
                board, scoreBoard, tileRack, tileBag, gameOver, anotherGo = playTurnComputer(board, scoreBoard,
                                                                                             scoreBoard2, tileRack,
                                                                                             tileBag, i, 9, randomVars)
            ...
            anotherGo = 1
            while anotherGo == 1:
                board, scoreBoard2, tileRack2, tileBag, gameOver, anotherGo = playTurnComputer(board, scoreBoard2,
                                                                                               scoreBoard, tileRack2,
                                                                                               tileBag, i, 0,
                                                                                               randomVars)
                # board,scoreBoard2,tileRack2,tileBag,gameOver,anotherGo = playTurnHuman(board,scoreBoard2,scoreBoard,
                # tileRack2,tileBag,i,numOfPlayers,8,randomVars)
                if viewGame and gameOver == 0:
                    print("Player 2")
